...
public class PessoaFisicaRepository {
    ...
    private static final String SELECT_PESSOA_FISICA =
            "SELECT P.COD_PESSOA, P.NME_PESSOA, P.FLG_CONSENTIMENTO_DADOS, PF.SGL_UF_NATURALIDADE, PF.DTA_NASCIMENTO, PF.TPO_SEXO  " +
                " FROM PESSOA P INNER JOIN PESSOA_FISICA PF ON P.COD_PESSOA = PF.COD_PESSOA ";
    private static final String SELECT_PESSOA_FISICA_ENDERECO =
            "SELECT P.COD_PESSOA, P.NME_PESSOA, P.FLG_CONSENTIMENTO_DADOS, PF.SGL_UF_NATURALIDADE, PF.DTA_NASCIMENTO, PF.TPO_SEXO,  " +
                    " " +
                    " FROM PESSOA P INNER JOIN PESSOA_FISICA PF ON P.COD_PESSOA = PF.COD_PESSOA " +
